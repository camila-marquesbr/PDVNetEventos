...
{
    public class RelSaldoEventosViewModel : INotifyPropertyChanged
    {
        private readonly RelatoriosService _svc = new();
        public ObservableCollection<SaldoEventoLinha> Itens { get; } = new();
        public ICommand RecarregarCommand { get; }

        public RelSaldoEventosViewModel()
        {
        ...
        {
            var dados = await _svc.ObterSaldoEventosAsync();
            Itens.Clear();
